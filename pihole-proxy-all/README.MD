# Traefik to loadbalance DNS to Pi-hole DNS instances with Docker
...
services:
  traefik:
    ...
    volumes:
      ...
      #- "/home/docker/traefik/log/traefik.log:/var/log/traefik.log"
...
services:
  ...
  pihole:
    ...
    labels:
      ...
      - traefik.udp.routers.dnsudp.service=dnsudp
